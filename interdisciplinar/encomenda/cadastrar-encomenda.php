...
<head>
    ...
    <link rel="stylesheet" href="cadastrar-encomenda.css">
...
<body>
  ...
  <form method="GET" action="crudencomenda.php">
    ...
    <label for="">Código Encomenda</label>
     <input type="text" name="codEncomenda" required maxlength="20">

     <label for="">Remetente</label>
     <input type="text" name="remetente" required max="100"> 
