...
require_once('../conexao.php');
  ...
  $retorno = $conexao->prepare('SELECT nome_interno, id_funcionario,interno,horario_saida,data_saida,horario_chegada, data_chegada,motivo, autorizado, matricula  FROM monitoramento  ');
  $retorno->execute();
